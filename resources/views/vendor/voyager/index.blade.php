    ...
    <div class="panel panel-bordered">
        ...
        <div class="panel-body"style="background-color:#f6f6f6;">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="dash-white-box mb-15">
                        ...
                        <div class="dash-price">
                            <span class="v-top"></span>
                            <b style="font-size:28px;" class="total-revenue">0</b>
                        </div>
                    </div>
                    <div class="dash-white-box mb-15">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="dash-white-box mb-15">
                        <div class="dash-box-title"><span class="fw-700">Transactions Total</span></div>
                        <div class="dash-price">
                            <span class="v-top"></span>
            ...
            $('#dateRangePicker').daterangepicker({
                ...
                switch (label) {
                    ...
                    case 'Last Month':
                        ...
                        break;
                    default:
                        activeFilter = 'custom'; // Use 'custom' for any custom date range
                        break;
                }
                fetchTransactionsCount(activeFilter)
                
            });
            $('#dateRangePicker span').html(moment().format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));

            function fetchTransactionsCount(filter='today'){
                $.ajax({
                    ...
                    success: function(response) {
                       ...
                       $('.total-revenue').html(response.total_revenue.toFixed(2)+ ' GHS')
